...
## Skill Level
Intermediate - Advanced: Though this is based on how many and what features can be included.

## Art Style
I have a vision of this being quite realistic for characters with quite detailed backgrounds. UI is also a big one for this game as this will always be visible.

## Artwork
- Full screen backgrounds
- Players
- Move UI Icons
- Health Bars, levels ups etc
- Menu Screen
- Upgrades screen

## Timescale
I think a couple of months for this full time would probably get us most of the way.
